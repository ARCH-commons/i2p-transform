...
/* Replace PCORNet Labs (LOINC) hierarchy with the local hierarchy.
*/

-- Create temporary table for mapping LOINC codes to PCORI specimen source values
CREATE TABLE TEMP_LAB_LOINC_MAP (PCORI_BASECODE VARCHAR2(50 BYTE), PCORI_SPECIMEN_SOURCE VARCHAR2(50 BYTE));
INSERT ALL
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('SERUM, PLASMA, or SR_PLS','10839-9')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('SERUM, PLASMA, or SR_PLS','12187-1')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('SERUM, PLASMA, or SR_PLS','12189-7')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('SERUM, PLASMA, or SR_PLS','13969-1')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('SERUM, PLASMA, or SR_PLS','14682-9')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','14775-1')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('SERUM, PLASMA, or SR_PLS','16255-2')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','17856-6')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','20509-6')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('SERUM, PLASMA, or SR_PLS','20569-0')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','21232-4')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('SERUM, PLASMA, or SR_PLS','2154-3')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('SERUM, PLASMA, or SR_PLS','2157-6')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('SERUM, PLASMA, or SR_PLS','2160-0')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','30313-1')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','30350-3')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','30351-1')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','30352-9')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('SERUM, PLASMA, or SR_PLS','32673-6')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('SERUM, PLASMA, or SR_PLS','33204-9')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','34714-6')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('SERUM, PLASMA, or SR_PLS','35203-9')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','38483-4')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','42757-5')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('SERUM, PLASMA, or SR_PLS','44784-7')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','4548-4')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','46418-0')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('SERUM, PLASMA, or SR_PLS','47213-4')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','48425-3')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','48426-1')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('SERUM, PLASMA, or SR_PLS','49136-5')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','49551-5')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('SERUM, PLASMA, or SR_PLS','49563-0')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','50756-6')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','55782-7')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','59260-0')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','59826-8')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('PPP','6301-6')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','6597-9')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('SERUM, PLASMA, or SR_PLS','6598-7')
	INTO TEMP_LAB_LOINC_MAP (PCORI_BASECODE, PCORI_SPECIMEN_SOURCE) VALUES ('BLOOD','718-7')
SELECT * FROM DUAL;
...
with terms_loinc as (
  select 
    ht.*, replace(ht.c_basecode, 'LOINC:', '') lc
  from 
   "&&i2b2_meta_schema"."&&terms_table" ht
  where c_fullname like '\i2b2\Laboratory Tests\%' and c_basecode like 'LOINC:%' order by c_hlevel 
  )
select
  tl.c_hlevel, 
  ...
  tl.c_tooltip, tl.m_applied_path, tl.update_date, tl.download_date, tl.import_date, 
  tl.sourcesystem_cd, tl.valuetype_cd, tl.m_exclusion_cd, tl.c_path, tl.c_symbol,
  tllm.pcori_basecode, tl.lc pcori_specimen_souce
from terms_loinc tl left join temp_lab_loinc_map tllm on tl.lc = tllm.pcori_specimen_source
order by c_hlevel
;

-- Drop temporary table
DROP TABLE TEMP_LAB_LOINC_MAP;

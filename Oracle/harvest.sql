...
CREATE TABLE harvest(
    ...
    REFRESH_HASH_TOKEN_DATE varchar(2) NULL,
    --REFRESH_LDS_ADDRESS_HISTORY_DATE varchar(2) NULL,
    --REFRESH_IMMUNIZATION_DATE varchar(2) NULL,
...
INSERT INTO harvest(NETWORKID, NETWORK_NAME, DATAMARTID, DATAMART_NAME, DATAMART_PLATFORM, CDM_VERSION, DATAMART_CLAIMS, DATAMART_EHR,
    ...
    OBSCLIN_DATE_MGMT, OBSGEN_DATE_MGMT, ADDRESS_PERIOD_START_MGMT, ADDRESS_PERIOD_END_MGMT,VX_RECORD_DATE_MGMT,

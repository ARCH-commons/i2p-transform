...
CREATE TABLE harvest(
    ...
    OBSGEN_START_DATE_MGMT varchar(2) NULL,
    OBSGEN_STOP_DATE_MGMT  varchar(2) NULL,
    ...
    REFRESH_LDS_ADDRESS_HX_DATE date NULL,
...
INSERT INTO harvest(NETWORKID, NETWORK_NAME, TOKEN_ENCRYPTION_KEY, DATAMARTID, DATAMART_NAME, DATAMART_PLATFORM, CDM_VERSION, DATAMART_CLAIMS, DATAMART_EHR,
    ...
    OBSCLIN_START_DATE_MGMT, OBSCLIN_STOP_DATE_MGMT, OBSGEN_DATE_MGMT,OBSGEN_START_DATE_MGMT,OBSGEN_STOP_DATE_MGMT, ADDRESS_PERIOD_START_MGMT, ADDRESS_PERIOD_END_MGMT,VX_RECORD_DATE_MGMT,
    VX_ADMIN_DATE_MGMT,VX_EXP_DATE_MGMT,REFRESH_HASH_TOKEN_DATE,REFRESH_LDS_ADDRESS_HX_DATE, REFRESH_IMMUNIZATION_DATE, REFRESH_DEMOGRAPHIC_DATE, REFRESH_ENROLLMENT_DATE,
	...
	hl.DEATH_DATE_MGMT, hl.MEDADMIN_START_DATE_MGMT, hl.MEDADMIN_STOP_DATE_MGMT, hl.OBSCLIN_START_DATE_MGMT, hl.OBSCLIN_STOP_DATE_MGMT ,hl.OBSGEN_DATE_MGMT,
    hl.OBSGEN_START_DATE_MGMT, hl.OBSGEN_STOP_DATE_MGMT,
  ...
  case when (select records from cdm_status where task = 'lds_address_history') > 0 then current_date else null end REFRESH_LDS_ADDRESS_HX_DATE,
  case when (select records from cdm_status where task = 'immunization') > 0 then current_date else null end REFRESH_IMMUNIZATION_DATE,

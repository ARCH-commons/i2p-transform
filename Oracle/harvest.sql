...
INSERT INTO harvest(NETWORKID, NETWORK_NAME, TOKEN_ENCRYPTION_KEY, DATAMARTID, DATAMART_NAME, DATAMART_PLATFORM, CDM_VERSION, DATAMART_CLAIMS, DATAMART_EHR,
    ...
    OBSCLIN_START_DATE_MGMT, OBSGEN_DATE_MGMT, ADDRESS_PERIOD_START_MGMT, ADDRESS_PERIOD_END_MGMT,VX_RECORD_DATE_MGMT,
    ...
    REFRESH_DEATH_DATE, REFRESH_DEATH_CAUSE_DATE, REFRESH_MED_ADMIN_DATE, REFRESH_OBS_CLIN_DATE, REFRESH_PROVIDER_DATE, REFRESH_OBS_GEN_DATE, OBSCLIN_STOP_DATE_MGMT
)
  ...
  case when (select records from cdm_status where task = 'obs_clin') > 0 then current_date else null end OBSCLIN_STOP_DATE_MGMT

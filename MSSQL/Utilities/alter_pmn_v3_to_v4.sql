...
Alter Table pmnencounter add PAYER_TYPE_PRIMARY varchar(4) NULL;

Alter Table pmnencounter add PAYER_TYPE_SECONDARY varchar(4) NULL;
...
Alter Table pmnpro_cm add PRO_MEASURE_SCORE varchar(8) NULL;

Alter Table pmnpro_cm add PRO_MEASURE_THETA varchar(8) NULL;

Alter Table pmnpro_cm add PRO_MEASURE_SCALED_TSCORE varchar(8) NULL;

Alter Table pmnpro_cm add PRO_MEASURE_STANDARD_ERROR varchar(8) NULL;

Alter Table pmnpro_cm add PRO_MEASURE_COUNT_SCORED varchar(8) NULL;
...
Alter Table pmnprescribing add RX_DISPENSE_AS_WRITTEN varchar(50) NULL;

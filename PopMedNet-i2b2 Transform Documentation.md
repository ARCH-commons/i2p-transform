...
3. NEW! You must run the PCORI_MEDS_SCHEMA_CHANGE script on the database with your mapped pcornet_med ontology. This will add a pcori_cui and pcori_ndc code based on your mapping.
